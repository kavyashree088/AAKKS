...
import {getDashboardTweets, likeATweet, unlikeATweet, bookmarkATweet, unbookmarkATweet, setCurrentTweet, retweetWithoutComment, retweetWithComment} from '../JS/Actions/tweetAction.js';
import {
    Card,
    CardImg,
    CardText,
...
export class DashboardTweets extends Component {
   ...
   render(){
       ...
       if(allTweets && allTweets.length > 0){
           ...
           tweetsMarkup.push(<ReplyModal/>)
           tweetsMarkup.push(<TweetModal/>)
           return tweetsMarkup;
       } else {
           return <div></div>;
       }
