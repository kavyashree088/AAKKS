...
async function updateProfile(msg, callback) {
    ...
    var fullname=msg.data.profileDetails.firstName+' '+msg.data.profileDetails.lastName;

    try {
        Users.findOneAndUpdate({ 'username': msg.data.profileDetails.username }, {
            $set: {
                "firstName": msg.profileDetails.firstName,
                "lastName": msg.profileDetails.lastName,
                "description": msg.profileDetails.description,
                "state": msg.profileDetails.state,
                "city": msg.profileDetails.city,
                "zipcode": msg.profileDetails.zipcode,
