                    ...
                    <Col className="col-sm-6">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <Row>
                                    <a href="/followers" onClick={this.followersClickHandler}>{this.state.followers.length} Followers</a><emsp></emsp>
                                    <a href="/followers" onClick={this.followingClickHandler}>{this.state.following.length} Followers</a> 
                                </Row>
                            </div>
                            <div>
