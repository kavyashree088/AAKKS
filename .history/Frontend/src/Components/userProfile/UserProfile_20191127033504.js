    ...
    componentWillMount = () => {
        ...
        axios({
            ...
            .then(response => {
                ...
                this.setState({
                    username: details.rows.username,
                    email: details.rows.email,
                    city: details.rows.city,
                    state: details.rows.state,
                    zipcode: details.rows.zipcode,
                    description: details.rows.description,
                    followers:details.rows.followers,
                    following:details.rows.following,
                    profilePicture: undefined,
                })
            }).catch(error => {
                console.log(error);
