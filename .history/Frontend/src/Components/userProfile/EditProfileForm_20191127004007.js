                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Form.Group controlId="formUserCity">
                                ...
                                <Form.Control onChange={this.cityChangeHandler} type="text" placeholder="bio" />
                            </Form.Group>
                            <Form.Group controlId="formUserState">
                                <Form.Label>State</Form.Label>
                                <Form.Control onChange={this.stateChangeHandler} type="text" placeholder="bio" />
                            </Form.Group>
                            <Form.Group controlId="formUserZipcode">
                                <Form.Label>Zip code</Form.Label>
                                <Form.Control onChange={this.zipcodeChangeHandler} type="text" placeholder="bio" />
                            </Form.Group>
