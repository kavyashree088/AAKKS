    ...
    componentWillMount = () => {
        ...
        axios({
            ...
            .then(response => {
                ...
                this.setState({
                    username: response.details.rows.username,
                    email: response.details.rows.email,
                    city: response.details.rows.city,
                    state: response.details.rows.state,
                    zipcode: response.details.rows.zipcode,
                    description: response.details.rows.description,
                    followers:response.details.rows.followers,
                    following:response.details.rows.following,
                    profilePicture: undefined,
                })
            }).catch(error => {
                console.log(error);
                        ...
                        <div>
                            ...
                            <div>
                                <Tabs defaultActiveKey="profile" id="profileTweets">
                                    ...
                                    <Tab eventKey="Tweets & replies" title="tweets">
