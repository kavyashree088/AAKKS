...
class Follow extends Component {
    ...
    componentWillMount = () => {
        ...
        console.log(this.props.location.state.followers)
        console.log(this.props.location.state.following)
        axios({
            method: 'get',
            url: 'http://' + config.hostname + ':3001/getFollow',
            data: this.props.location.state.followers
        }).then(response=>{
            console.log(response)
        })
        axios.get('http://' + config.hostname + ':3001/getFollow',{data: this.props.location.state.followers})
        .then(response=>{
            console.log(response)
        })
        if (showFollowers) {
