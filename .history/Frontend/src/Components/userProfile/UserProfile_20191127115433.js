                        ...
                        <div>
                            ...
                            <div>
                                <Tabs defaultActiveKey="profile" id="profileTweets">
                                    ...
                                    <Tab eventKey="Tweets" title="tweets" className = "tweets-tab">
                                        
                                    </Tab>
                                    <Tab eventKey="Tweets & replies" title="Tweets & replies" className = "tweetsAndReplies-tab">
                                        
                                    </Tab>
                                    <Tab eventKey="Likes" title="likes" className = "likes-tab">
