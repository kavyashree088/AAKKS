                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Form.Group controlId="formUserDesc">
                                ...
                                <Form.Control onChange={this.descriptionChangeHandler} type="text" placeholder="bio" />
                            </Form.Group>
                           
                            <Form.Group controlId="formUserCity">
                                <Form.Label>City</Form.Label>
                                <Form.Control onChange={this.cityChangeHandler} type="text" placeholder="city" />
                            </Form.Group>
                            <Form.Group controlId="formUserState">
                                <Form.Label>State</Form.Label>
                                <Form.Control onChange={this.stateChangeHandler} type="text" placeholder="state" />
                            </Form.Group>
                            <Form.Group controlId="formUserZipcode">
                                <Form.Label>Zip code</Form.Label>
                                <Form.Control onChange={this.zipcodeChangeHandler} type="text" placeholder="zipcode" />
                            </Form.Group>
