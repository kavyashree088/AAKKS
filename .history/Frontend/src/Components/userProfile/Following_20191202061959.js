            ...
            <div>
                <Row>
                    ...
                    <Col className="col-sm-6">
                        <Tabs id="controlled-tab-example" activeKey={this.state.activeKey} mountOnEnter={true} onSelect={this.changeActiveTabKey}>
                            <Tab eventKey="Followers" title="Followers" onSelect={this.changeActiveTabKey}>
                                <TabContent activeKey="Followers" onSelect={this.changeActiveTabKey}>

                                </TabContent>
                            </Tab>
                            <Tab eventKey="Following" title="Following" onSelect={this.changeActiveTabKey}>
                                <TabContent activeKey="Following" onSelect={this.changeActiveTabKey}>
