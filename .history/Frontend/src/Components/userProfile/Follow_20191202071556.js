    ...
    changeActiveTabKey = (e) => {
        ...
        axios({
            ...
            if (response.status === 200) {
                console.log('response from DB: ');
                console.log(response.data);
                followersArr.push(response.data.rows.followers);
                followingArr.push(response.data.rows.following);
            } else {
                console.log("Status Code: ", response.status);
                console.log(response.data.responseMessage);
            }
            ...
            <div>
                <Card bg="secondary" text="white" style={{
                    ...
                    <Card.Body>
                        ...
                        <Card.Subtitle className="mb-2 text-muted">{aFollowerUserName}</Card.Subtitle>
                        <Card.Text style={{
                            textAlign: "end",
                            fontWeight: "900",
                        }}>
