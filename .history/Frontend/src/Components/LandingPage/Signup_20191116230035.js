                        ...
                        <center>
                            <Form style={{ width: '20rem' }}>
                                ...
                                <Form.Group controlId="formBasicEmail">
                                    <Form.Label className="fontColor">User name</Form.Label>
                                    <Form.Control required  placeholder="User name" name="buyerEmailId" onChange={this.emailIdChangeHandler} />
                                </Form.Group>

                                <Form.Group controlId="formBasicPassword">
                                    <Form.Label className="fontColor" >Password</Form.Label>
                                ...
                                <Form.Group controlId="formGridPhoneNumber">
                                    <Form.Label className="fontColor">Phone Number</Form.Label>
