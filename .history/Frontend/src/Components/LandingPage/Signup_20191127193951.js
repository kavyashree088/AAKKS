...
class Signup extends Component {
    ...
    stateChangeHandler = (e) => {
        ...
        var isValidAbb =/(^(?-i:A[LKSZRAEP]|C[AOT]|D[EC]|F[LM]|G[AU]|HI|I[ADLN]|K[SY]|LA|M[ADEHINOPST]|N[CDEHJMVY]|O[HKR]|P[ARW]|RI|S[CD]|T[NX]|UT|V[AIT]|W[AIVY])$)/.test(e.target.value)
        if(isValidState){
            this.setState({
