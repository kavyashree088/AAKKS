...
import Following from './Components/UserProfile/Followers'
    ...
    return (
      <Router>
        <Switch>
          ...
          <Route exact path="/followers" component={Follow}></Route>
          <Route exact path="/following" component={Follow}></Route>
        </Switch>
      </Router>
