...
router.get('/getFollow/:data',requireAuth, function (req, res) {
  // console.log(req)
  
   console.log("Inside getFollow post request");
   console.log("Sending Request Body:");
 
   console.log(req.params.data)
  // let username = req.body.currentUsername
     try {
     kafka.make_request('profileTopic', { "path": "getFollow", "data":req.params.data }, function (err, result) {
       console.log("result")
       console.log(result)
